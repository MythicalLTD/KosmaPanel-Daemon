                ...
                case "system/info":
                    {
                        ...
                        {
                            code = 200,
                            os_type = LinuxMetricsService.os_type,
                            kernel = LinuxMetricsService.kernel_name,
                            uptime = LinuxMetricsService.uptime,
                            disk_info = new
                            {
                                total = LinuxMetricsService.disk_total,
                                used = LinuxMetricsService.disk_used,
                                free = LinuxMetricsService.disk_free,
                            },
                            ram_info = new
                            {
                                total = LinuxMetricsService.ram_total,
                                used = LinuxMetricsService.ram_used,
                                free = LinuxMetricsService.ram_free,
                            },
                            cpu_info = new
                            {
                                name = LinuxMetricsService.cpu_model,
                                usage = LinuxMetricsService.cpu_usage,
                            },
